        ...
        <div className="filters">
          ...
          <label className="label">
            ...
            <input
                ...
                value={minSubtotal}
                onChange={(e) => { setMinSubtotal(e.target.value); setPage(1); }}
          ...
          <label className="label">
            ...
            <input
                className="input mono"
                value={maxSubtotal}
                onChange={(e) => { setMaxSubtotal(e.target.value); setPage(1); }}
                type="number" min="0" step="0.01" placeholder="500"
            />
          </label>

          <button className="btn" onClick={resetFilters} style={{ alignSelf: "end" }}>Reset</button>
        </div>
                  ...
                  {pageData.length === 0 ? (
                      ...
                      pageData.map((o) => (
                          <tr key={o.id}>
                            ...
                            {/* Повернули snake_case, який віддає бекенд */}
